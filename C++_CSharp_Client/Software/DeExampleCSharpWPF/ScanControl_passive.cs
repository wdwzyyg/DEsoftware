...
namespace ScanControl_passive
{
    ...
    public class ScanControl_cz
    {
        ...
        public HW_STATUS_RETURNS ScanControlInitialize(double x_amp, double y_amp, double[] Xarray_vol, double[] Yarray_vol, int[] Xarray_index, int[] Yarray_index, int v, double delay, int recording_rate, int Option2D, int Nmultiframes)
        {
            int status;
            string sent;
